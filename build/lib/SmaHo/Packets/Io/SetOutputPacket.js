...
class SetOutputPacket extends PacketBase_1.default {
    constructor(output, state) {
        super(PacketType_1.default.Output, 3, new SmaHoPacketizer_1.default());
...
module.exports = SetOutputPacket;
//# sourceMappingURL=SetOutputPacket.js.map