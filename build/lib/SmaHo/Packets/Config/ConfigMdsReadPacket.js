...
class ConfigMdsReadPacket extends PacketBase_1.default {
    constructor(index) {
        super(PacketType_1.default.ConfigMdsRead, 2, new SmaHoPacketizer_1.default()); //  cmd, index byte
...
module.exports = ConfigMdsReadPacket;
//# sourceMappingURL=ConfigMdsReadPacket.js.map