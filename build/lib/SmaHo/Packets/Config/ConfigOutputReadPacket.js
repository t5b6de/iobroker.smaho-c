...
class ConfigOutputReadPacket extends PacketBase_1.default {
    constructor(index) {
        super(PacketType_1.default.ConfigOutputRead, 2, new SmaHoPacketizer_1.default()); //  cmd, index byte
...
module.exports = ConfigOutputReadPacket;
//# sourceMappingURL=ConfigOutputReadPacket.js.map